...
module.exports = "<div>\n  <h1>\n    Welcome to {{ title }}!\n  </h1>\n</div>\n<h2>Here are some event to get you started: </h2>\n<mat-tab-group\n  dynamicHeight=\"false\"\n>\n  <mat-tab\n    *ngFor=\"let eventitem of eventitems\"\n    label=\"{{eventitem.date}}\"\n    >\n    <span>{{eventitem.day}}</span> {{eventitem.date}}\n    <ul>\n      <li *ngFor=\"let event of eventitem.events\">\n        <a href=\"{{'https://mommypoppins.com' + event._field_data.nid.entity.node_url}}\" target=\"_blank\">{{event.node_title}}</a>\n      </li>\n    </ul>\n  </mat-tab>\n</mat-tab-group>\n"
...
var AppComponent = /** @class */ (function () {
    function AppComponent(contentService) {
        ...
        this.title = 'MP Events';
    }
    AppComponent.prototype.getEventitems = function () {
        var _this = this;
        this.contentService.getEventitems()
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__content_service__ = __webpack_require__("./src/app/content.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["G" /* NgModule */])({
            ...
            providers: [
                __WEBPACK_IMPORTED_MODULE_6__content_service__["a" /* ContentService */],
            ],
